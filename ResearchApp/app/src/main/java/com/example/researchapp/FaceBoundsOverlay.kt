...
import com.example.researchapp.models.Facing
import com.example.researchapp.models.Orientation
...
class FaceBoundsOverlay @JvmOverloads constructor(
     ...
     */
    fun updateFaces(bounds: List<FaceBounds>): MutableList<FaceBounds> {
        facesBounds.clear()
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        facesBounds.forEach {
            ...
            /*try {
                textView.setText(it.box.height())
            }
            catch (e:NullPointerException)
            {
                println(it.box.height())
            }*/
        }
    }
